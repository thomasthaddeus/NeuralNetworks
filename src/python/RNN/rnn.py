...
Extended Summary:
    The RNN class allows you to easily construct an RNN model with multiple layers, specify activation functions, loss functions, and optimizers, and train the model on input data.
...
class RNN:
    def __init__(self, layers, activation_fn, loss_fn, optimizer):
        ...
        Args:
            layers (list): List of integers specifying the number of units in each RNN layer.
    ...
    def train(self, X, y, epochs=10, batch_size=32, validation_split=0.2):
        ...
        Args:
            ...
            validation_split (float): Fraction of the data to use for validation (default: 0.2).
        """
